...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <a href="{{ route('dashboard') }}">
                        <svg class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" viewBox="0 0 316 316">
                            {{-- {!! file_get_contents(resource_path('icons/laravel-logo.svg')) !!} --}}
                        </svg>
                    </a>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6 relative">
                    ...
                    <!-- Guest Links -->
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-300 hover:text-gray-900">Login</a>
                        <a href="{{ route('register') }}" class="text-gray-600 dark:text-gray-300 hover:text-gray-900">Register</a>
                    </div>
                    @endauth
        ...
        <div id="mobileMenu" class="hidden sm:hidden">
            ...
            <div class="pt-2 pb-3 space-y-1">
                <a href="{{ route('dashboard') }}"
                   ...
                   {{ request()->routeIs('dashboard')
                        ...
                        : 'border-transparent text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900' }}">
                    Dashboard
                </a>
            </div>
            ...
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                                class="block w-full text-left px-4 py-2 text-base text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-900">
                            Log Out
                        </button>
                    </form>
                </div>
            ...
            <div class="pt-2 pb-3 space-y-1">
                <a href="{{ route('login') }}"
                   class="block pl-3 pr-4 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-900">
                    Login
                </a>
